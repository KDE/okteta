...
AbstractByteArrayView* ByteArrayRowViewAbstractByteArrayViewIfTest::createByteArrayView()
{
    auto* byteArrayView = new ByteArrayRowView();

    return byteArrayView;
}

void ByteArrayRowViewAbstractByteArrayViewIfTest::deleteByteArrayView(AbstractByteArrayView* byteArrayView)
{
