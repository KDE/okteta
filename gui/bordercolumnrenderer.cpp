...
void BorderColumnRenderer::renderColumn(QPainter* painter, PixelXRange Xs, PixelYRange Ys)
{
    Q_D(BorderColumnRenderer);
...
void BorderColumnRenderer::renderEmptyColumn(QPainter* painter, PixelXRange Xs, PixelYRange Ys)
{
    Q_D(BorderColumnRenderer);
