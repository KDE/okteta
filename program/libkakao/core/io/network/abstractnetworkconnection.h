...
#ifndef ABSTRACTNETWORKCONNECTION_H
#define ABSTRACTNETWORKCONNECTION_H

// Qt
#include <QtCore/QObject>


class AbstractNetworkConnection : public QObject
{
    Q_OBJECT

  public:
    explicit AbstractNetworkConnection( QObject* parent = 0 );
