 ...
 : mDocument( 0 )
{
    ...
    mReadOnlyButton = new ToggleButton( KIcon("object-unlocked.png"), readWriteText, statusBar );
    mReadOnlyButton->setCheckedState( KIcon("object-locked.png"), readOnlyText );
