...
//     addXmlGuiControllerFromFactory(OverwriteOnlyControllerFactory() );
    ...
    addXmlGuiControllerFromFactory(PrintControllerFactory(userMessagesHandler));
    ...
    addToolFromFactory(FilterToolViewFactory(), FilterToolFactory(userMessagesHandler));
