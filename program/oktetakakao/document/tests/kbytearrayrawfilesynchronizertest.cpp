...
//     QFile::copy(QString::fromLatin1(KDESRCDIR) + QLatin1String("/Paris"), mDataDir + QLatin1String("/Europe/Paris"));
    ...
    mComponentData = new KComponentData( "KByteArrayRawFileSynchronizerTest" );
}
...
void KByteArrayRawFileSynchronizerTest::testLoadFromUrl()
{
    ...
    KAbstractDocument *document = loadByteArrayFromRawFile( fileUrl );
...
QTEST_MAIN( KByteArrayRawFileSynchronizerTest )
