...
#ifndef BYTEARRAYNETWORKSERVERCONNECTION_H
#define BYTEARRAYNETWORKSERVERCONNECTION_H
...
class ByteArrayNetworkServerConnection : public AbstractModelNetworkServerConnection
{
  Q_OBJECT

  public:
    ByteArrayNetworkServerConnection( QObject* parent = 0 );
...
//     QByteArray baseData();
//     int versionCount();
//     QList<KHECore::ByteArrayChange> changes( int firstVersionIndex, int lastVersionIndex );
