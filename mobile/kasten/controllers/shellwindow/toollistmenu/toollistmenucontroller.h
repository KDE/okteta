...
class MOBILEKASTENCONTROLLERS_EXPORT ToolListMenuController : public AbstractActionController
{
  Q_OBJECT

  public:
    ToolListMenuController( /*If::ToolViewShowable* actionAable, KXMLGUIClient* guiClient*/ );
