...
LoaderActionController::LoaderActionController( DocumentSyncManager* syncManager, QMenuBar* menuBar )
  : mSyncManager( syncManager )
{
    menuBar->addAction( i18n("Open"), this, SLOT(load()) );
}


void LoaderActionController::setTargetModel( AbstractModel* model )
{
Q_UNUSED( model )
}
