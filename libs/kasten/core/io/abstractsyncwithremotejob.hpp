...
protected:
    KASTENCORE_NO_EXPORT explicit AbstractSyncWithRemoteJob(std::unique_ptr<AbstractSyncWithRemoteJobPrivate>&& ddd);
...
protected:
    const std::unique_ptr<AbstractSyncWithRemoteJobPrivate> d_ptr;
};
