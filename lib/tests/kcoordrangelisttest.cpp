...
static KBufferCoord Start1( Pos1, Line1 );
static KBufferCoord End1(   Pos2, Line2 );
static KBufferCoord Start2( Pos1, Line3 );
static KBufferCoord End2(   Pos2, Line4 );
...
void KCoordRangeListTest::testAddJoinableSections()
{
  ...
  // in front
  KBufferCoord OtherStart( 0, 0 );
  KBufferCoord OtherEnd = Start1;
  OtherEnd.goLeft(0);
