...
#ifndef BYTEARRAYBASE32STREAMENCODERCONFIGEDITOR_H
#define BYTEARRAYBASE32STREAMENCODERCONFIGEDITOR_H
...
class ByteArrayBase32StreamEncoderConfigEditor : public AbstractModelStreamEncoderConfigEditor
{
  ...
  public:
    explicit ByteArrayBase32StreamEncoderConfigEditor( ByteArrayBase32StreamEncoder* encoder, QWidget* parent = 0 );
    virtual ~ByteArrayBase32StreamEncoderConfigEditor();
