...
#ifndef BYTEARRAYUUENCODINGSTREAMENCODERCONFIGEDITORFACTORY_H
#define BYTEARRAYUUENCODINGSTREAMENCODERCONFIGEDITORFACTORY_H
...
class ByteArrayUuencodingStreamEncoderConfigEditorFactory : public AbstractModelStreamEncoderConfigEditorFactory
{
  public:
    ...
    virtual ~ByteArrayUuencodingStreamEncoderConfigEditorFactory();
