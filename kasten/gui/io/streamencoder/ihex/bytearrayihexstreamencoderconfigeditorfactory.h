...
#ifndef BYTEARRAYIHEXSTREAMENCODERCONFIGEDITORFACTORY_H
#define BYTEARRAYIHEXSTREAMENCODERCONFIGEDITORFACTORY_H
...
class ByteArrayIHexStreamEncoderConfigEditorFactory : public AbstractModelStreamEncoderConfigEditorFactory
{
  public:
    ...
    virtual ~ByteArrayIHexStreamEncoderConfigEditorFactory();
