...
#ifndef BYTEARRAYXXENCODINGSTREAMENCODERCONFIGEDITOR_H
#define BYTEARRAYXXENCODINGSTREAMENCODERCONFIGEDITOR_H
...
class ByteArrayXxencodingStreamEncoderConfigEditor : public AbstractModelStreamEncoderConfigEditor
{
  ...
  public:
    explicit ByteArrayXxencodingStreamEncoderConfigEditor( ByteArrayXxencodingStreamEncoder* encoder, QWidget* parent = 0 );
