...
#ifndef BYTEARRAYXXENCODINGSTREAMENCODERCONFIGEDITORFACTORY_H
#define BYTEARRAYXXENCODINGSTREAMENCODERCONFIGEDITORFACTORY_H
...
class ByteArrayXxencodingStreamEncoderConfigEditorFactory : public AbstractModelStreamEncoderConfigEditorFactory
{
  public:
    ...
    virtual ~ByteArrayXxencodingStreamEncoderConfigEditorFactory();
