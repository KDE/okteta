...
#ifndef BYTEARRAYSRECSTREAMENCODERCONFIGEDITOR_H
#define BYTEARRAYSRECSTREAMENCODERCONFIGEDITOR_H
...
class ByteArraySRecStreamEncoderConfigEditor : public AbstractModelStreamEncoderConfigEditor
{
  ...
  public:
    explicit ByteArraySRecStreamEncoderConfigEditor( ByteArraySRecStreamEncoder* encoder, QWidget* parent = 0 );
    virtual ~ByteArraySRecStreamEncoderConfigEditor();
