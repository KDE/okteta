...
#ifndef BYTEARRAYSRECSTREAMENCODERCONFIGEDITORFACTORY_H
#define BYTEARRAYSRECSTREAMENCODERCONFIGEDITORFACTORY_H
...
class ByteArraySRecStreamEncoderConfigEditorFactory : public AbstractModelStreamEncoderConfigEditorFactory
{
  public:
    ...
    virtual ~ByteArraySRecStreamEncoderConfigEditorFactory();
