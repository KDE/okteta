...
class OKTETAKASTENGUI_EXPORT ByteArrayViewProfileManager : public QObject
{
  ...
  Q_SIGNALS:
    void viewProfilesAdded( const QList<Kasten::ByteArrayViewProfile>& viewProfiles );
    void viewProfilesChanged( const QList<Kasten::ByteArrayViewProfile>& viewProfiles );
    void viewProfilesRemoved( const QList<Kasten::ByteArrayViewProfile>& viewProfiles );
