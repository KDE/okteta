...
{
    mIterableProperties.emplace_back(ScriptValuePropertyInfo{s_type, QScriptValue::PropertyFlags(QScriptValue::Undeletable)});
    mIterableProperties.emplace_back(ScriptValuePropertyInfo{s_target, QScriptValue::PropertyFlags(QScriptValue::Undeletable)});
    mIterableProperties.emplace_back(ScriptValuePropertyInfo{s_scale, QScriptValue::PropertyFlags(QScriptValue::Undeletable)});
    mIterableProperties.emplace_back(ScriptValuePropertyInfo{s_interpretFunc, QScriptValue::PropertyFlags(QScriptValue::Undeletable)});
}
