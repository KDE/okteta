...
AdditionalData::AdditionalData(const QScriptValue& validate, const QScriptValue& update) :
...
AdditionalData::AdditionalData(const AdditionalData& data) :
    mUpdateFunction(data.mUpdateFunction), mValidationFunction(data.mValidationFunction),
