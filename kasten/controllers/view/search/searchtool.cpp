...
constexpr char SearchTool::ConfigGroupId[];
constexpr char SearchTool::CaseSensitivityConfigKey[];

constexpr Qt::CaseSensitivity SearchTool::DefaultCaseSensitivity;
